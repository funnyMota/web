...
// 得到所有电话号码以1结尾的学生
// const arr=students.filter((item)=>item.tel.endsWith('1'))
// console.log(arr);

// 得到所有学生姓名组成的数组
// const arr=students.map((item)=>item.name)
// console.log(arr);

// 得到所有女生的姓名和电话号码 [ {name:'monica', tel:'18122223333'} ]
// let arr=students.filter((item)=>item.sex==='女').map((item)=>{
...
let arr=students.map((item)=>item.name).reduce((a,b)=>a+=`<li>${b}</li>`,'')
console.log(arr);
