...
// 是否包含年龄大于28岁的男生
// const isFind=students.some((item)=>(item.age>28&&item.sex==='男'))
// console.log(isFind);

// 是否所有的女生年龄都在28岁以内
const isFind=students.every((item)=>(item.sex==='女'&&item.age<28))
console.log(isFind);
