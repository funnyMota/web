...
// 得到所有女生
// var stus=filter(students,function(i){
//   return i.sex==="女";
// })
// console.log(stus);

// // 得到所有20岁以下的女生
// stus=filter(students,function(i){
//   return i.sex==="女"&&i.age<20;
// })
// console.log(stus);

// 得到所有姓赵的同学
stus=filter(students,function(i){
  return i.name.startsWith('赵');
})
console.log(stus);
// 得到所有居住在黑龙江的女生
stus=filter(students,function(i){
  return i.address.includes("黑龙江")&&i.sex==="女";
})
console.log(stus);
