...
for(let i=0;i<students.length;i++){
  if(students[i].tel.endsWith("1")){
    studentsTel.push(students[i]);
  }
}
console.log(studentsTel);
// 得到所有学生姓名组成的数组（新数组）
var studentsName=[];
for(let i=0;i<students.length;i++){
...
for(let i=0;i<students.length;i++){
  if(students[i].sex==="女"){
    girlsName.push(students[i].name);
  }
}
...
for(let i=0;i<students.length;i++){
  if(students[i].sex==="女"){
    girlsNameTel.push({name:students[i].name, tel:students[i].tel});
  }
}
...
var studentsNameAge={name:[],age:[]};
for(let i=0;i<students.length;i++){
  studentsNameAge.name.push(students[i].name);
  studentsNameAge.age.push(students[i].age);
}
console.log(studentsNameAge);
// 找到id为796997的学生对象
var studentsId796997=[];
for(let i=0;i<students.length;i++){
  if(students[i].id==796997){
    studentsId796997.push(students[i]);
  }
}
console.log(studentsId796997);
// 是否包含年龄大于28岁的男生
var isAge28=[];
for(let i=0;i<students.length;i++){
  if(students[i].age>28){
    isAge28.push(students[i]);
  }
}
console.log(isAge28);
// 是否所有的女生年龄都在28岁以内
